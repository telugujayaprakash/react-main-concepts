...
// // const { Actors } = require('../models/MovieSchema')
...
//         //     genre: item.genre,                                  // }  here we are mapping json data to movie schema
//         //     language: item.lang,                                     // }
//         //     // moovies:Movies.populate('movies')                       // }
//         // }));
//         // await Movies.insertOne(formattedData)
//         // console.log('File conversion Completed & Uploaded to DB');
//         console.log("Data", jsonData)
//         res.status(200).json({ message: "File conversion & uploaded Successfully", data: jsonData })
//     } catch (error) {
//         console.log(error)
